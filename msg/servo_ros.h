#ifndef _ROS_msg_servo_ros_h
#define _ROS_msg_servo_ros_h
...
namespace msg
{
  ...
  class servo_ros : public ros::Msg
  {
    public:
      int32_t id;
      int32_t direction;
    ...
    const char * getType(){ return "msg/servo_ros"; };
    const char * getMD5(){ return "1c2a077cbe9849919857083db5c0919c"; };
