#ifndef _ROS_dependant_api_rcmd_motor_h
#define _ROS_dependant_api_rcmd_motor_h
...
namespace dependant_api
{
  ...
  class rcmd_motor : public ros::Msg
  {
    public:
      uint32_t id;
      int32_t hor_angle;
    ...
    const char * getType(){ return "dependant_api/rcmd_motor"; };
