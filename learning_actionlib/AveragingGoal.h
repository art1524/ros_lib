#ifndef _ROS_learning_actionlib_AveragingGoal_h
#define _ROS_learning_actionlib_AveragingGoal_h
...
namespace learning_actionlib
{
  ...
  class AveragingGoal : public ros::Msg
  {
    ...
    const char * getType(){ return "learning_actionlib/AveragingGoal"; };
